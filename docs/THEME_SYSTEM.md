...
> **Importante**: Para cada feature, consultar también los recursos de diseño ubicados en `/docs/features/[feature]/recursos/DESIGN.md` que contienen las especificaciones visuales específicas de esa pantalla.

---

## Fuente de Verdad

Este documento define los tokens base del sistema de diseño. Sin embargo, **cada feature puede tener especificaciones visuales particulares** documentadas en sus propios recursos de diseño. En caso de conflicto, precedence order:

1. **Recursos de feature** (`/docs/features/[feature]/recursos/`) - Especificaciones visuales particulares
2. **Este documento** - Tokens base y sistema general
3. **GOLDEN_RULES.md** - Principios de implementación (no hardcodear valores)
...
Para especificaciones visuales detalladas de cada pantalla, consultar:

| Feature | Recursos de Diseño |
|---------|-------------------|
| Auth | `features/auth/recursos/DESIGN.md` + `code.html` + `screen.png` |
| Home | `features/home/recursos/DESIGN.md` + `code.html` + `screen.png` |

Cada carpeta de recursos contiene:
- **DESIGN.md**: Especificaciones técnicas del diseño (colores, tipografía, spacing)
- **code.html**: Mockup interactivo en HTML/Tailwind (fuente visual de verdad)
- **screen.png**: Captura estática del diseño

> **Importante**: El archivo `code.html` es la **fuente visual de verdad**. Si hay discrepancias entre DESIGN.md y code.html, prevalece code.html.
